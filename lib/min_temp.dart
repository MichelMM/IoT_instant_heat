        ...
        child: Column(
          ...
          mainAxisAlignment: MainAxisAlignment.center,
            children: [
              ...
              SizedBox(child: Text("Selecciona la temperatura mínima de tu bebida",style: GoogleFonts.lato(fontSize: 32,color: const Color(0xFF47525E),fontWeight: FontWeight.w300),textAlign: TextAlign.center,),width: 300,),
              ...
              OutlinedButton(
            onPressed: (){
              Navigator.of(ContextHolder.currentContext).push(MaterialPageRoute(builder: (_) => const MaxTemp()));
            },
